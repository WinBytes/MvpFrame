...
import com.rain.mvpframe.BuildConfig;
import com.rain.mvpframe.base.GlobalApplication;
import com.rain.mvpframe.core.api.ApiService;
import com.rain.mvpframe.core.http.interceptor.NetCacheInterceptor;
import com.rain.mvpframe.core.http.interceptor.OfflineCacheInterceptor;
import com.rain.mvpframe.utils.CacheUtils;
...
public class HttpModule {
    ...
    OkHttpClient provideOkHttpClient(OkHttpClient.Builder builder) {
        ...
        builder.cookieJar(new PersistentCookieJar(new SetCookieCache(),
                new SharedPrefsCookiePersistor(GlobalApplication.getContext())));
