...
package com.rain.mvpframe.core.rx;
...
import com.rain.mvpframe.base.IView;
import com.rain.mvpframe.core.http.BaseResponse;
import com.rain.mvpframe.core.http.exception.ServerException;
import com.rain.mvpframe.utils.CommonUtils;
...
public abstract class BaseObserver<T> extends ResourceObserver<BaseResponse<T>> {
    ...
    public void onComplete() {
        ...
        if (!CommonUtils.isNetworkConnected()) {
            mView.showErrorMsg(GlobalApplication.getContext().getString(R.string.http_error));
        }
